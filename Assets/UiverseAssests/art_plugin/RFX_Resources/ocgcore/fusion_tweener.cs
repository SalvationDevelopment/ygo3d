...
public class fusion_tweener : MonoBehaviour {
    ...
    void Update()
    {
        if (Environment.TickCount - start_time > 0)
        {
            step = 1;
        }
        if (Environment.TickCount - start_time > 1500)
        {
            step = 2;
        }
        if (Environment.TickCount - start_time > 3000)
        {
            step = 3;
        }
        if (Environment.TickCount - start_time > 3500)
        {
            step = 4;
        }
