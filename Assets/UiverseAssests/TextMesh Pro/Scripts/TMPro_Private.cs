...
{  
    ...
    public partial class TextMeshPro
    {
        ...
        */
        ...
        void Awake()
        {
            //debugger.Log("Awake() called on Object ID " + GetInstanceID());          
            ...
            {
                debugger.LogWarning("Converting Vertex Colors from Color32 to Color.");
            ...
            if (m_mesh == null)
            {                              
                //debugger.Log("Creating new mesh.");
                m_mesh = new Mesh();
        ...
        void OnEnable()
        {
            ...
            //if (m_meshInfo == null)
            //    debugger.Log("Mesh Info is null.");
        }


       void OnDisable()
        {
            //debugger.Log("***** OnDisable() called on object ID " + GetInstanceID() + ". *****"); //+ m_renderer.GetComponent<MeshFilter>().sharedMesh.GetInstanceID() + "  Mesh ID " + m_mesh.GetInstanceID() + "  MeshFilter ID " + m_meshFilter.GetInstanceID()); //has been called. HavePropertiesChanged = " + havePropertiesChanged); // has been called on Object ID:" + gameObject.GetInstanceID());      
            //if (m_meshFilter.sharedMesh != null)
            //    debugger.Log("OnDisable() called. We have a valid mesh with ID " + m_meshFilter.sharedMesh.GetInstanceID());
            //else
            //    debugger.Log("OnDisable() called. We DO NOT have a valid mesh");
        ...
        void OnDestroy()
        {
            //debugger.Log("***** OnDestroy() called on object ID " + GetInstanceID() + ". *****");
        ...
        void OnValidate()
        {
            ...
            //debugger.Log("TextMeshPro OnValidate() called. Renderer.MeshFilter ID " + m_renderer.GetComponent<MeshFilter>().GetInstanceID() + "  Mesh ID " + m_mesh.GetInstanceID() + "  MeshFilter ID " + m_meshFilter.GetInstanceID()); //has been called. HavePropertiesChanged = " + havePropertiesChanged); // has been called on Object ID:" + gameObject.GetInstanceID());      
            //debugger.Log("TextMeshPro OnValidate() called. Mesh ID " + m_mesh.GetInstanceID() + "  MeshFilter ID " + m_meshFilter.GetInstanceID()); //has been called. HavePropertiesChanged = " + havePropertiesChanged); // has been called on Object ID:" + gameObject.GetInstanceID());      
        ...
        {
            //debugger.Log("ON_MATERIAL_PROPERTY_CHANGED event received. Targeted Material is: " + mat.name + "  m_sharedMaterial: " + m_sharedMaterial.name + "  m_renderer.sharedMaterial: " + m_renderer.sharedMaterial);         
            ...
            if (m_fontAsset.atlas.GetInstanceID() != m_renderer.sharedMaterial.GetTexture(ShaderUtilities.ID_MainTex).GetInstanceID())
            {
                ...
                //m_renderer.sharedMaterial = m_fontAsset.material;
                debugger.LogWarning("Font Asset Atlas doesn't match the Atlas in the newly assigned material. Select a matching material or a different font asset.");
            }

            if (m_renderer.sharedMaterial != m_sharedMaterial) //    || m_renderer.sharedMaterials.Contains(mat))
            {
                //debugger.Log("ON_MATERIAL_PROPERTY_CHANGED Called on Target ID: " + GetInstanceID() + ". Previous Material:" + m_sharedMaterial + "  New Material:" + m_renderer.sharedMaterial); // on Object ID:" + GetInstanceID() + ". m_sharedMaterial: " + m_sharedMaterial.name + "  m_renderer.sharedMaterial: " + m_renderer.sharedMaterial.name);         
        ...
        void ON_DRAG_AND_DROP_MATERIAL(GameObject obj, Material currentMaterial, Material newMaterial)
        {
            ...
            //debugger.Log("Drag-n-Drop Event - Receiving Object ID " + GetInstanceID() + ". Target Object ID " + obj.GetInstanceID() + ".  New Material is " + mat.name + " with ID " + mat.GetInstanceID() + ". Base Material is " + m_baseMaterial.name + " with ID " + m_baseMaterial.GetInstanceID());
        ...
        //{
        //    debugger.Log("Prefab ID " + obj.name + " has been updated. Mesh ID " + m_mesh.GetInstanceID());
        ...
        void LoadFontAsset()
        {          
            //debugger.Log("TextMeshPro LoadFontAsset() has been called."); // Current Font Asset is " + (font != null ? font.name: "Null") );
            ...
            if (m_fontAsset == null)  
            {
                ...
                //debugger.Log("Font Asset are Null. Trying to Load Default Arial SDF Font.");
            ...
            else
            {
                ...
                //debugger.Log("Font Asset name:" + font.material.name);
        ...
        void UpdateMask()
        {
            //debugger.Log("UpdateMask() called.");
            ...
            if (!m_isMaskingEnabled)
            {
                //debugger.Log("Masking is not enabled.");
            ...
            */
            ...
            {                
                ...
                //debugger.Log("Creating new MaterialPropertyBlock.");            
            }

            //debugger.Log("Updating Material Property Block.");
        ...
        void SetMeshArrays(int size)
        {
            ...
            //debugger.Log("Bounds were updated.");
        ...
        void SetFaceColor(Color32 color)
        {
            ...
            //debugger.Log("Material ID:" + m_fontMaterial.GetInstanceID());
        ...
        void SetShaderType()
        {
            if (m_isOverlay)
            {
                ...
                //debugger.Log("Text set to Overlay mode.");
            }
            else
            {   // TODO: This section needs to be tested.
                ...
                m_sharedMaterial = m_renderer.material;
                //debugger.Log("Text set to Normal mode.");
            }
        ...
        {
            //debugger.Log("OnPreRenderObject() called.");
            //debugger.Log(m_renderer.sortingLayerID);
        }
        ...
        {                      
            ...
            //debugger.Log("OnWillRenderObject() called!");            
        ...
        {
            //debugger.Log("***** GenerateTextMesh() ***** Iteration Count: " + loopCountA + ".  Min: " + m_minFontSize + "  Max: " + m_maxFontSize + "  Font size is " + m_fontSize);
            ...
            for (int i = 0; m_char_buffer[i] != 0; i++)
            {
				...
				//debugger.Log("i:" + i + "  Character [" + (char)charCode + "]");
                loopCountE += 1;
                ...
                //    }
                //}              
                //debugger.Log("Char [" + (char)charCode + "] ASCII " + charCode); //is using FontIndex: " + m_fontIndex);
                ...
                //debugger.Log("Character [" + (char)charCode + "] at Index: " + m_characterCount + " with Ascender of " + ascender + " and Descender of " + descender + "  Max Ascender: " + m_maxAscender + "  Max Descender: " + m_maxDescender);
                ...
                if (charCode != 32 && charCode != 9 && charCode != 10 && charCode != 13)
                {
                    ...
                    //debugger.Log("Line Number: " + m_lineNumber + " Char [" + (char)charCode + "] Extents MinX: " + m_textInfo.lineInfo[m_lineNumber].lineExtents.min.x + "  MaxX: " + m_textInfo.lineInfo[m_lineNumber].lineExtents.max.x); 
                   ...
                   // debugger.Log("Line # " + m_lineNumber + " BaseScale: " + baseScale + "  MaxFontScale: " + m_maxFontScale);     
                    ...
                    if (m_xAdvance + m_cached_GlyphInfo.xAdvance * m_fontScale > m_marginWidth + 0.0001f && !m_textContainer.isDefaultWidth)
                    {
                        ...
                        if (enableWordWrapping && m_characterCount != m_firstVisibleCharacterOfLine)
                        {
                            ...
                            //debugger.Log("Line # " + m_lineNumber + " Last Character of Line is [" + m_textInfo.characterInfo[m_characterCount - 1].character + "]. Last Visible Character is [" + m_textInfo.characterInfo[m_lastVisibleCharacterOfLine].character + "].");
                            ...
                            {                         
                                //debugger.Log("Line # " + m_lineNumber + "'s lineOffset between Characters [" + m_textInfo.characterInfo[firstCharacterOfLine].character + "] and [" + m_textInfo.characterInfo[m_characterCount - 2].character + "] needs to be adjusted. BaseScale: " + baseScale + "  MaxFontScale: " + m_maxFontScale);
                                // Compute Offset
                                ...
                                //debugger.Log("Line #" + m_lineNumber + " Offset Adjustment: " + (offsetDelta - lineOffsetDelta));
                            }
                            m_isNewPage = false;
                            ...
                            if (m_lineHeight == 0)
                            {
                                //debugger.Log("Line # " + m_lineHeight + " - Font Scale is " + m_fontScale + "  Max Font Scale is " + m_maxFontScale);
                ...
                if (m_maxAscender - descender + (m_alignmentPadding.w * 2 * m_fontScale) > marginHeight && !m_textContainer.isDefaultHeight)
                {
                    ...
                    switch (m_overflowMode)
                    {
                        ...
                        case TextOverflowModes.Page:
                            ...
                            //debugger.Log("Character is [" + (char)charCode + "] with ASCII (" + charCode + ") on Page " + m_pageNumber);
                ...
                {
                    //debugger.Log("Line # " + m_lineNumber + " Last Character of Line is [" + m_textInfo.characterInfo[m_characterCount].character + "]. Last Visible Character is [" + m_textInfo.characterInfo[m_lastVisibleCharacterOfLine].character + "].");
                ...
                //{
                    //debugger.Log("Char [" + (char)charCode + "] at Index " + (m_characterCount % 5));
            ...
            //debugger.Log("Iteration Count: " + loopCountA + ". Final Point Size: " + m_fontSize);
            ...
            for (int i = 0; i < m_characterCount; i++)
            {
                ...
                switch (lineAlignment)
                {
                    ...
                    case TextAlignmentOptions.MidlineJustified:
                        ...
                        //debugger.Log("Char [" + (char)charCode + "] Code: " + charCode + "  Offset: " + justificationOffset + "  # Spaces: " + lineInfo.spaceCount + "  # Characters: " + lineInfo.characterCount + "  CurrentLine: " + currentLine + "  Last Line: " + lastLine + "  i: " + i);                      
                        break;
                }
            ...
            //m_isCharacterWrappingEnabled = false;
            //debugger.Log("Corners [0] " + corners[0] + "  [1] " + corners[1] + " [2] " + corners[2] + " [3] " + corners[3]);
            //debugger.Log("Done rendering.");          
            ...
            if ((m_textContainer.isDefaultWidth || m_textContainer.isDefaultHeight) && m_textContainer.isAutoFitting)
            {
                ...
                if (m_textContainer.isDefaultWidth)
                {
                    ...
                    //debugger.Log("Text Container's Width adjusted to fit text.");
                }
                ...
                if (m_textContainer.isDefaultHeight)
                {
                    ...
                    //debugger.Log("Text Container's Height adjusted to fit text.");
                }
             
                //debugger.Log("Auto-fitting Text. Default Width:" + m_textContainer.width + "  Default Height:" + m_textContainer.height);
            ...
            //Profiler.EndSample();
            //m_StopWatch.Stop(); 
            //debugger.Log("Preferred Width: " + m_preferredWidth + "  Height: " + m_preferredHeight); // + "  Margin Width: " + marginWidth + "  xAdvance Total: " + totalxAdvance);
            //debugger.Log("Done Rendering Text Object. Total Character Count is " + m_textInfo.characterCount + ".  Preferred Width: " + m_preferredWidth + "  Height: " + m_preferredHeight);
            ...
            else
            {
                switch (tagCode)
                {
                    ...
                    case 1118: // <font=xx>
                        ...
                        //m_fontScale = (m_fontSize / m_fontAssetArray[m_fontIndex].fontInfo.PointSize * (m_isOrthographic ? 1 : 0.1f));
                        //debugger.Log("Font Index = " + m_fontIndex);
                        return true;
