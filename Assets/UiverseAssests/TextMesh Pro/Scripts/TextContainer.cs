...
namespace TMPro
{
    ...
    public class TextContainer : MonoBehaviour
    {
        ...
        {
            get { return m_pivot; }
            set { /*debugger.Log("Pivot has changed.");*/ if (m_pivot != value) { m_pivot = value; m_anchorPosition = GetAnchorPosition(m_pivot); m_hasChanged = true; OnContainerChanged(); } }
        }
        [SerializeField]
        ...
        public TextContainerAnchors anchorPosition
        {
            ...
            set { /*debugger.Log("Anchor has changed.");*/ if (m_anchorPosition != value) { m_anchorPosition = value; m_pivot = GetPivot(m_anchorPosition); m_hasChanged = true; OnContainerChanged(); } }
        }
        [SerializeField]
        ...
        {
            get { return m_rect; }
            set { /*debugger.Log("Rectangle has changed.");*/ if (m_rect != value) { m_rect = value; /*m_size = new Vector2(m_rect.width, m_rect.height);*/ m_hasChanged = true; OnContainerChanged(); } }
        }
        [SerializeField]
        private Rect m_rect;
        ...
        public Vector2 size
        {
            ...
            set { /*debugger.Log("Size has changed.");*/ if (new Vector2(m_rect.width, m_rect.height) != value) { SetRect(value); m_hasChanged = true; m_isDefaultWidth = false; m_isDefaultHeight = false; OnContainerChanged(); } }
        }
        ...
        public float width
        {
            ...
            set { /*debugger.Log("Width has changed.");*/ SetRect(new Vector2(value, m_rect.height)); m_hasChanged = true; m_isDefaultWidth = false; OnContainerChanged(); }
        }
        ...
        public Vector4 margins
        {
            ...
            set { if (m_margins != value) { /*debugger.Log("Margins have changed.");*/ m_margins = value; m_hasChanged = true; OnContainerChanged(); } }
        }
        [SerializeField]
        ...
        void Awake()
        {
            ...
            //debugger.Log("TextContainer Awake() called.");
            ...
            if (m_rect.width == 0 || m_rect.height == 0)
            {
                ...
                {
                    debugger.LogWarning("Converting from using anchor and lineLength properties to Text Container.");
        ...
        void OnEnable()
        {
            //debugger.Log("Text Container OnEnable() called.");
            if (m_transform == null)
                m_transform = GetComponent(typeof(Transform)) as Transform;
        ...
        void OnValidate()
        {
            //debugger.Log("OnValidate() called.");
            m_hasChanged = true;
            OnContainerChanged();       
        }
        ...
        */
        ...
        {           
            ...
            //debugger.Log("Pivot " + m_pivot + "  Corners 0: " + m_corners[0] + "  1: " + m_corners[1] + "  2: " + m_corners[2] + "  3: " + m_corners[3]);
        }
        ...
        private void UpdateWorldCorners()
        {
            ...
            //debugger.Log("Pivot " + m_pivot + "  Corners 0: " + m_worldCorners[0] + "  1: " + m_worldCorners[1] + "  2: " + m_worldCorners[2] + "  3: " + m_worldCorners[3]);
