    ...
    public class InlineGraphicManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (gameObject.GetComponent<TextMeshPro>() == null && gameObject.GetComponent<TextMeshProUGUI>() == null)           
                debugger.LogWarning("The InlineGraphics Component must be attached to a TextMesh Pro Object");
        ...
        {            
            ...
            {
                //debugger.Log(obj as SpriteAsset != null ? "SpriteAsset Event!" : "Sprite Atlas Event!");
        ...
        {
            //debugger.Log("**** Loading SpriteAsset *****");
        ...
        public void AddInlineGraphicsChild()
        {
            if (m_inlineGraphic != null)
            {
                //debugger.LogWarning("A child Inline Graphics object already exists.");
                return;
            }
        ...
        public void AllocatedVertexBuffers(int size)
        {
            ...
            {               
                ...
                //debugger.Log("Increasing Sprite Mesh Allocations to " + m_uiVertex.Length);
            }                                 
        }
        ...
        public SpriteInfo GetSprite(int index)
        {
            ...
            {     
                debugger.LogWarning("No Sprite Asset is assigned.");
                return null;
            }
            ...
            {
                debugger.LogWarning("Sprite index exceeds the number of sprites in this Sprite Asset.");
                return null;
            }
