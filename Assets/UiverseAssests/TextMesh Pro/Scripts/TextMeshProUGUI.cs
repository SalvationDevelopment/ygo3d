...
namespace TMPro
{
    ...
    public partial class TextMeshProUGUI : Graphic, ILayoutElement, IMaskable
    {
        ...
        //    //    debugger.Log("GetMaterialProperty() Material is " + m_sharedMaterial );
        //    //    return m_sharedMaterial; // base.material;
        //    //}
        //    //set
        //    //{
        //    //    debugger.Log("SetMaterialProperty");
        ...
        {
            get { return m_margin; }
            set { if (m_margin != value) { m_margin = value; /* debugger.Log("Margin is " + margin); ComputeMarginSize();*/ havePropertiesChanged = true; m_marginsHaveChanged = true; } }
        }      
        ...
        private float GetPreferredWidth()
        {
            ...
            debugger.Log("GetPreferredWidth() Called. Returning width of " + m_preferredWidth);
        ...
        private float GetPreferredHeight()
        {
            ...
            debugger.Log("GetPreferredHeight() Called. Returning height of " + m_preferredHeight);
        ...
        {
            //debugger.Log("CalculateLayoutHorizontal() at Frame: " + Time.frameCount); // called on Object ID " + GetInstanceID());
            ...
            //{
                ...
                //debugger.Log("Preferred Width: " + m_preferredWidth + "  Margin Width: " + m_marginWidth + "  Preferred Height: " + m_preferredHeight + "  Margin Height: " + m_marginHeight + "  Rendered Width: " + m_renderedWidth + "  Height: " + m_renderedHeight + "  RectTransform Width: " + m_rectTransform.rect);
        ...
        public void CalculateLayoutInputVertical()
        {
            ...
            //debugger.Log("CalculateLayoutInputVertical() at Frame: " + Time.frameCount); // called on Object ID " + GetInstanceID());
            ...
            //{
                ...
                //debugger.Log("Preferred Height: " + m_preferredHeight + "  Margin Height: " + m_marginHeight + "  Preferred Width: " + m_preferredWidth + "  Margin Width: " + m_marginWidth + "  Rendered Width: " + m_renderedWidth + "  Height: " + m_renderedHeight + "  RectTransform Width: " + m_rectTransform.rect);
        ...
        //{
        //    get { debugger.Log("Default Material called."); return m_sharedMaterial; }
        //}


        //public bool MaskEnabled()
        //{
        //    debugger.Log("MaskEnabled() called.");
        //    return true;
        //}
        ...
        {
            //debugger.Log("***** PARENT MASK STATE CHANGED *****");
            ...
            else
            {
                ...
                //debugger.Log("Masking Enabled. Assigning " + m_maskingMaterial.name + " with ID " + m_maskingMaterial.GetInstanceID());                           
            }
        ...
        */
        ...
        {
            //debugger.Log("ForceMeshUpdate() called.");
            //havePropertiesChanged = true;
            OnPreRenderCanvas();            
        }
