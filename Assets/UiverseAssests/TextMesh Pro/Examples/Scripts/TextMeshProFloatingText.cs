...
namespace TMPro.Examples
{
    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            //debugger.Log(m_parentScript.NumberOfNPC);
        }
        ...
        void Start()
        {
            if (SpawnType == 0)
            {
                //debugger.Log("Spawning TextMesh Pro Objects.");
            ...
            {
                //debugger.Log("Spawning TextMesh Objects.");
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                if (current_Count <= 3)
                {
                    //debugger.Log("Fading Counter ... " + current_Count.ToString("f2"));
            ...
            //debugger.Log("Done Counting down.");
        ...
        public IEnumerator DisplayTextMeshFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                //debugger.Log("Current Count:" + current_Count.ToString("f2"));
