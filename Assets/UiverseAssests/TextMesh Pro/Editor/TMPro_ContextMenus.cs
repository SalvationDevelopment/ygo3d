...
namespace TMPro.EditorUtilities
{
    ...
    public class TMPro_ContextMenus : MaterialEditor
    {
        ...
        static void DuplicateMaterial(MenuCommand command)
        {
            ...
            {
                debugger.LogWarning("Material is an instance and cannot be converted into a permanent asset.");
                return;
            }
        ...
        static void PasteMaterialProperties(MenuCommand command)
        {
            ...
            {
                debugger.LogWarning("No Material Properties to Paste. Use Copy Material Properties first.");
                return;
            }
