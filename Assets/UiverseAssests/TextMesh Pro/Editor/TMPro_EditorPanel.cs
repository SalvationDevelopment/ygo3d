...
namespace TMPro.EditorUtilities
{
    ...
    public class TMPro_EditorPanel : Editor
    {
        ...
        public void OnEnable()
        {
            ...
            //debugger.Log("OnEnable() for Inspector ID " + this.GetInstanceID() + " has been called.");
        ...
        {
            //debugger.Log("OnDisable() for Inspector ID " + this.GetInstanceID() + " has been called.");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (Event.current.type == EventType.DragExited)
            {
                ...
                {
                    debugger.Log("Material has been changed to " + m_currentMaterialID + ". Previous Material was " + m_previousMaterialID);
