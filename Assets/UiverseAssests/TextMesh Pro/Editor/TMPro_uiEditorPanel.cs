...
namespace TMPro.EditorUtilities
{
    ...
    public class TMPro_uiEditorPanel : Editor
    {
        ...
        {
            //debugger.Log("New Instance of TMPRO UGUI Editor with ID " + this.GetInstanceID());
            ...
            */
            ...
            {               
                ...
                //debugger.Log("Currently Assigned Material is " + m_targetMaterial + ".  Font Material is " + m_textMeshProScript.fontSharedMaterial);
            }
        ...
        {
            //debugger.Log("OnDisable() for GUIEditor Panel called.");
            Undo.undoRedoPerformed -= OnUndoRedo;
            
			// Destroy material editor if one exists
            if (m_materialEditor != null)
            {
                //debugger.Log("Destroying Inline Material Editor.");
        ...
        {           
            ...
            if (m_uiRenderer != null && m_uiRenderer.GetMaterial() != null)
            {
                ...
                //debugger.Log(mat + "  " + m_targetMaterial);
                
                if (mat != m_targetMaterial)
                {
                    // Destroy previous Material Instance
                    //debugger.Log("New Material has been assigned.");
            ...
            {
                //debugger.Log("Properties have changed.");                
            ...
            switch (evt.type)
            {
                ...
                case EventType.DragPerform:
                    ...
                    {                      
                        ...
                        //debugger.Log("Drag-n-Drop Material is " + mat + ". Target Material is " + m_targetMaterial + ".  Canvas Material is " + m_uiRenderer.GetMaterial()  );
                        ...
                        if (!mat || mat == m_uiRenderer.GetMaterial() || mat.GetTexture(ShaderUtilities.ID_MainTex).GetInstanceID() != m_textMeshProScript.font.atlas.GetInstanceID())
                        {
                            if (mat && mat.GetTexture(ShaderUtilities.ID_MainTex).GetInstanceID() != m_textMeshProScript.font.atlas.GetInstanceID())
                                debugger.LogWarning("Drag-n-Drop Material [" + mat.name + "]'s Atlas does not match the assigned Font Asset [" + m_textMeshProScript.font.name + "]'s Atlas."); 
                            break;
                        }
        ...
        public void OnSceneGUI()
        {
            ...
            if (old_left != new_left)
            {
                ...
                //debugger.Log("Left Margin H0:" + handlePoints[0] + "  H1:" + handlePoints[1]);
                hasChanged = true;
            }
            ...
            if (old_top != new_top)
            {
                ...
                //debugger.Log("Top Margin H1:" + handlePoints[1] + "  H2:" + handlePoints[2]);   
                hasChanged = true;
            }
            ...
            if (old_right != new_right)
            {
                ...
                hasChanged = true;
                //debugger.Log("Right Margin H2:" + handlePoints[2] + "  H3:" + handlePoints[3]);
            }
            ...
            if (old_bottom != new_bottom)
            {
                ...
                hasChanged = true;
                //debugger.Log("Bottom Margin H0:" + handlePoints[0] + "  H3:" + handlePoints[3]);
            }
        ...
        private void OnUndoRedo()
        {
            ...
            //debugger.Log(m_textMeshProScript.fontMaterial);
            /*
            if (undoEventID != LastUndoEventID)
            {
                for (int i = 0; i < targets.Length; i++)
                {
                    //debugger.Log("Undo & Redo Performed detected in Editor Panel. Event ID:" + Undo.GetCurrentGroup());
        ...
        private UndoPropertyModification[] OnUndoRedoEvent(UndoPropertyModification[] modifications)
        {
            ...
            {
                //debugger.Log("Undo / Redo Event Registered in Editor Panel on Target: " + targetObject);
            ...
            //{
                ...
                //debugger.Log("Undo / Redo Event: Font Asset changed. Event ID:" + Undo.GetCurrentGroup());
            
            //}

            //debugger.Log("Undo / Redo Event Registered in Editor Panel on Target: " + modifiedProp.propertyPath + "  Undo Event ID:" + eventID + "  Stored ID:" + TMPro_EditorUtility.UndoEventID);
