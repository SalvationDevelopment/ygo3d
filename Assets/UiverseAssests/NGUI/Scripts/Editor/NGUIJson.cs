...
public class NGUIJson
{
	...
	static public void LoadSpriteData (UIAtlas atlas, TextAsset asset)
	{
		...
		if (decodedHash == null)
		{
			debugger.LogWarning("Unable to parse Json file: " + asset.name);
		}
	...
	static public void LoadSpriteData (UIAtlas atlas, string jsonData)
	{
		...
		if (decodedHash == null)
		{
			debugger.LogWarning("Unable to parse the provided Json string");
		}
		else LoadSpriteData(atlas, decodedHash);
	}
	...
	static void LoadSpriteData (UIAtlas atlas, Hashtable decodedHash)
	{
		...
		debugger.Log("Imported " + atlas.spriteList.Count + " sprites");
	}
...
*/
	...
	protected static bool serializeValue( object value, StringBuilder builder )
	{
		...
		// debugger.Log("type: " + t.ToString() + " isArray: " + t.IsArray);
