...
//    {
//#if UNITY_FLASH
//        debugger.LogError("WWW is not yet implemented in Flash");
//        return null;
//#else
//        WWW www = null;
//        try { www = new WWW(url); }
//        catch (System.Exception ex) { debugger.LogError(ex.Message); }
//        return www;
//#endif
//    }
...
//        catch (System.Exception ex) { debugger.LogError(ex != null ? ex.Message : "<null>"); }
//        return www;
//#endif
//    }
	...
	static public void SetDirty (UnityEngine.Object obj)
	{
		...
		if (obj)
		{
			//if (obj is Component) debugger.Log(NGUITools.GetHierarchy((obj as Component).gameObject), obj);
			//else if (obj is GameObject) debugger.Log(NGUITools.GetHierarchy(obj as GameObject), obj);
			//else debugger.Log("Hmm... " + obj.GetType(), obj);
