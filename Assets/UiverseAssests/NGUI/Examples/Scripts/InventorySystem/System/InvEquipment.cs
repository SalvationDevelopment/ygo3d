...
public class InvEquipment : MonoBehaviour
{
	...
	public InvGameItem Replace (InvBaseItem.Slot slot, InvGameItem item)
	{
		...
		{
			debugger.LogWarning("Can't equip \"" + item.name + "\" because it doesn't specify an item slot");
		}
		return item;
	}
	...
	public InvGameItem Equip (InvGameItem item)
	{
		if (item != null)
		{
			...
			else debugger.LogWarning("Can't resolve the item ID of " + item.baseItemID);
		}
		return item;
	}
